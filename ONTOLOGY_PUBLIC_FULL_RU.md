...
Практическая документация для ИИ работаещему с программой: https://raw.githubusercontent.com/UserPC-SPB/Opterium/refs/heads/main/opterium_v1.0_spec.txt (содержит HELP, AXIOMS, GEOM, GPT, ACADEMY, PYTH, MACROS, DOCTOR, OPT_GEOM).
